...
import type { ExternalBlob as _ExternalBlob, MatchDecision as _MatchDecision, Message as _Message, PhotoPost as _PhotoPost, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async sendMessage(arg0: Principal, arg1: string, arg2: string | null, arg3: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(arg0, arg1, to_candid_opt_n33(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MatchDecision_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MatchDecision): MatchDecision {
...
async function from_candid_PhotoPost_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoPost): Promise<PhotoPost> {
...
async function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PhotoPost]): Promise<PhotoPost | null> {
    return value.length === 0 ? null : await from_candid_PhotoPost_n23(_uploadFile, _downloadFile, value[0]);
}
async function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [{
        id: Principal;
        age: bigint;
        bio: string;
        displayName: string;
    ...
    return value.length === 0 ? null : await from_candid_record_n28(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        sent: from_candid_vec_n18(_uploadFile, _downloadFile, value.sent),
        unreadCount: value.unreadCount,
        received: from_candid_vec_n18(_uploadFile, _downloadFile, value.received)
    };
}
...
async function from_candid_record_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        photo: await from_candid_ExternalBlob_n25(_uploadFile, _downloadFile, value.photo)
    };
}
async function from_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        photoPosts: await from_candid_vec_n22(_uploadFile, _downloadFile, value.photoPosts),
...
function from_candid_record_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        decision: from_candid_variant_n32(_uploadFile, _downloadFile, value.decision)
    };
}
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PhotoPost>): Promise<Array<PhotoPost>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PhotoPost_n23(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MatchDecision>): Array<MatchDecision> {
    return value.map((x)=>from_candid_MatchDecision_n30(_uploadFile, _downloadFile, x));
}
